...
This class is colloqually considered the CS version of MATH 314/MATH 347. Material from that class is generally applicable here.

## Related Classes

If the math side of this class interests you, consider taking more mathematics classes!

- <CourseLink code="MATH 444" />, <CourseLink code="MATH 447" />,
  <CourseLink code="MATH 424" /> - These are the undergraduate (real) analysis
  classes offered, listed in increasing difficulty.
- <CourseLink code="MATH 417" />, <CourseLink code="MATH 427" /> - There are the
  undergraduate abstract algebra classes offered, listed in increasing
  difficulty.
- <CourseLink code="MATH 453" /> - Number Theory.
