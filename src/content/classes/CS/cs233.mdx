...
- <CourseLink code="CS 433" name="Computer System Organisation" />: If you
  enjoyed the architecture content in this class, consider taking CS 433, which
  presents modern computer architecture theory such as ILP, out-of-order
  execution, superscalar execution, instruction reordering, and cache
  optimisations. ECE 411 Computer Organization and Design is a more involved
  class that has you implement a CPU in Verilog. This class requires ECE 391 as
  a prerequisite.
