...
- <CourseLink code="STAT 400" name="Statistics and Probability I" />: If you
  want a more rigorous coverage of the probability/stats material in this
  course, take this course.
- <CourseLink code="CS 410" name="Statistics and Probability II" />: If you
  enjoyed the probability/stats material and want to learn more, take STAT410.
- <CourseLink code="CS 446" name="Machine Learning" />: If you want to learn
  more about the application of probability in machine learning, take
  <CourseLink code="CS 446" />, which contains material regarding ML theory in
  more classical machine learning methods.
- <CourseLink code="CS 473" name="Algorithms" />: If you want to learn more
  about the application of probability in algorithms, take
  <CourseLink code="CS 473" />, which covers a lot of content regarding
  randomized algorithms and approximation algorithms, which can involve
  randomized algorithms. Here are some of Professor Jeff Erickson's notes said
  topic:
  [[1]](https://jeffe.cs.illinois.edu/teaching/algorithms/notes/02-nutsbolts.pdf)
  and
  [[2]](https://jeffe.cs.illinois.edu/teaching/algorithms/notes/03-treaps.pdf).
- <CourseLink code="CS 407" name="Cryptography" />
  If you want to learn more cryptography, take this course.
