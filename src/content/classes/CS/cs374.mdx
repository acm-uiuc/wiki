...
- <CourseLink code="CS 473" name="Algorithms" />: If you enjoyed the algorithms
  section of this course and want to learn more (Knuth's Optimization, Monge
  Property, Tree DP, Randomized Algorithms, Flows, Matching, Approximation
  Algorithms), take this course.
- <CourseLink code="CS 475" name="Models of Computation" />: If you enjoyed the
  models of computation section of this course, that this course.
- <CourseLink code="CS 574" name="Randomized Algorithms" />: More randomized
  algorithms content.
- <CourseLink code="CS 579" name="Computational Complexity" />: If you enjoyed
  the hardness and decidability content, take this course.
