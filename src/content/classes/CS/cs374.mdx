...
- <CourseLink code="CS 473" name="Algorithms" />: If you enjoyed the algorithms
  section of this course and want to learn more (Knuth's Optimisation, Monge
  Property, Tree DP, Randomised Algorithms, Flows, Matching, Approximiation
...
- <CourseLink code="CS 574" name="Randomized Algorithms" />: More randomised
  algorithms content.
